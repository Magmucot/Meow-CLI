...
const I18N = {
  ru: {
    ...
    cmd_pins: "Список закрепленных сообщений",
    ...
    cmd_help: "Эта справка",
    cmd_exit: "Выход",
    cmd_trust: "Проверить или выдать доверие текущему репозиторию",
    trust_status: "Статус доверия: {status}",
    trust_trusted: "ДОВЕРЕННЫЙ",
    trust_untrusted: "НЕ ДОВЕРЕННЫЙ (Только чтение)",
    trust_blacklisted: "В ЧЕРНОМ СПИСКЕ (Угроза безопасности)",
    trust_granted: "Доверие выдано текущему репозиторию.",
    trust_blocked: "Невозможно выдать доверие: у репозитория плохая репутация.",
    trust_readonly_warning: "⚠️ Репозиторий не является доверенным. Работа в режиме ТОЛЬКО ЧТЕНИЕ.",
    stats_title: "◆ Status",
    tips_title: "✨ Tips",
